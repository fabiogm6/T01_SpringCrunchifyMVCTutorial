...
<%-- ${message} veio do CrunchifyHelloWorld.java em com.crunchify.controller--%>
<body>${message}
	...
	<div align='center'
		...
		Fábio /WEB-INF/jsp/welcome.jsp - Spring MCV Tutorial by <a href="http://crunchify.com">Crunchify</a>.
		Click <a
